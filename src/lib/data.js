...
export async function getData() {
	...
	const structured = data.map((row) => {
		...
		const element = {
			...
			net_import_reliance_percentage_of: row.net_import_reliance_percentage_of,
			net_import_reliance_percentage_of_2: row.net_import_reliance_percentage_of2,
			ret_reliance_import_percentage_of_3: row.ret_reliance_import_percentage_of3
